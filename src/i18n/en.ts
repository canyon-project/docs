  ...
  featureList: [
    {
      ...
      description:
        "Leveraging efficient React frameworks and type-safe support with Next.js, TypeScript, and Shadcn UI to build modern applications.",
    },
    {
      title: "Tailwind CSS & Iconify Icons",
      description:
        "Atomic CSS integrated with Tailwind CSS and Iconify icons, enabling efficient design and responsive UI.",
    },
    {
      title: "Dark Mode",
