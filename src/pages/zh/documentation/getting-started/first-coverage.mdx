...
<Callout emoji="💡">
  ...
  1. 更多 <LocalizedLink href={'/documentation/ecosystem/babel-plugin-istanbul'}>babel-plugin-canyon</LocalizedLink> 配置方法。

  2. 各Canyon变量的含义可查看 [变量说明](/documentation/reference/api)。
</Callout>
...
<Callout type="info" emoji="ℹ️">
  ...
  具体可查看[支持的provider列表](/documentation/reference/supported-ci-providers)。
</Callout>
...
具体可参考[UI自动化测试](/static/documentation/getting-started/first-coverage/documentation/end-to-end-testing/playwright)。
