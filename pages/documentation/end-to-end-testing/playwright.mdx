...
Playwright is a Node.js library for browser automation, and Canyon provides a method inheritance for collecting coverage data during playwright runs.
...
After running the Playwright test cases, the code coverage data files will be generated in the `.canyon_output` directory.

### Report

We provide a reporting tool. [canyon-uploader](/documentation/ecosystem/tools/canyon-uploader)
