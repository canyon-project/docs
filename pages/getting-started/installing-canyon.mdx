...
建表sql文件在 [canyon/packages/canyon-backend/prisma/schema.sql](https://github.com/canyon-project/canyon/blob/main/packages/canyon-backend/prisma/create-table.sql) 中
